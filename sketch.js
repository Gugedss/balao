...
if (arrowcollide.greenBalloon){
greenBalloon.lifetime = -1
}
if(arrowcollide.blueBalloon){
 blueBalloon.lifetime = -1
}
 if(arrowcollide.redBalloon){
  redBalloon.lifetime = -1
 }

 if(arrowcollide.pinkBalloon){

 pinkBalloon.lifetime = -1
